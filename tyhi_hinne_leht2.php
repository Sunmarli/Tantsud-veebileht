...
$kask_select=$yhendus->prepare(
    "SELECT paariID,hinne1 FROM tantsupaarid WHERE hinne2=0  and hinne1!=0;");
$kask_select->bind_result($paariID,$hinne1);
$kask_select->execute();
...
if (isset($_POST['submit'])) {
    ...
    $kask_update = $yhendus->prepare("UPDATE tantsupaarid SET hinne2 = ? WHERE paariID = ?");
    $kask_update->bind_param("ii", $selectedValue, $selected_id);
    $kask_update->execute();
    $kask_update->close();
    $yhendus->close();
    header("Location: tyhi_hinne_leht3.php");
    exit();
}
...
<nav>
    ...
    <div class="container">
        <div class="column">
            ...
            <a href="tyhi_hinne_leht.php">Tagasi</a>
        </div>
        <div class="column">
            <div class="user-info">
